"""
Django settings for keralasellers project.
...
CORS_ALLOWED_ORIGINS = [
    ...
    "https://yourdomain.com",  # your actual domain in prod
]
...
AUTHENTICATION_BACKENDS = [
    'users.backends.SellerAuthBackend',  # Custom backend for phone-based auth
